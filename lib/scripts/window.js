...
<body>
    <div class="container">
        ...
        <h2>Welcome to SwingOS</h2>
        <p>A New Era of MGN Just Launched<br><small></p>
        <p style="color: red;">Remember to enter Fullscreen so SwingOS formats correctly!</p>
        <p>Get Ready for a Polished Landing Page Coming Your Way</p>
        <hr>
        <p>Discover SwingOS: A Look into the future.</p>
        <p>How to use Apps<br><small></p>
        <p>Green Dot to Maximize</p>
        <p>Yellow Dot to Minimize</p>
        <p>Red Dot to close app</p>
        <p>Entertainment<br><small></p>
        <p>SwingOS comes with games from MGN equipped for every user.</p>
        <p>App Store<br><small></p>
        <p>The Banana Store comes with past MGN Versions for users to install or uninstall at any time.</p>
        <p>ㅤ</p>
        <p>Have fun with SwingOS!</p>
    </div>
</body>
</html>
...
if (!localStorage.getItem('visitedBefore')) {
    createWindow('Welcome to SwingOS!', welcome, '50%', '50%');
...
const proxy = `
<iframe src="https://totallysocialstudies.com/service/hvtrs8%2F-wuw%2Cgmoelg.aoo%2F" frameborder="0" style="width: 100%; height: 100%; border: none;"></iframe>
`
...
const games = `
<iframe id="ifr" src="https://monkegaminghtml.netlify.app/other/gameview.html" style="width:100%; height:100%;" frameborder="none"></iframe>
`
const terminal = `
...
},
{
    ...
    text: 'Games',
    clickFunction: function () {
        createWindow('Monkes Game Jungle', games, '40%', '60%');
    }
},
{
    id: 3,
    ...
    text: 'Calculator',
    clickFunction: function () {
        createWindow('Calculator', calculatorApp, '15%', '50%');
    }
},
{
    id: 4,
    ...
    text: 'Terminal',
    clickFunction: function () {
        createWindow('Banana Terminal', terminal, '40%', '45%');
    }
},
];
