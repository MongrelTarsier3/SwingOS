...
<head>
    ...
    <title>Welcome to SwingOS!</title>
    <style>
        .container {
            max-width: 800px;
            margin: 0 auto;
...
const data = [{
  ...
  clickFunction: function() {
    createWindow('Search', proxy, '60%', '70%');
  }
},
{
  id: 2, ewd
  ...
  text: 'Games',
  clickFunction: function() {
    createWindow('Monke' Game Jungle, games, '40%', '60%');
  }
},
{
  id: 3,
  ...
  text: 'Calculator',
  clickFunction: function() {
    createWindow('Banana Calculator', calculatorApp, '15%', '50%');
  }
},
{
];
