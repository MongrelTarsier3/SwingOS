...
// Example usage:
setTimeout(function() {
  showNotification("Welcome to SwingOS", "Feel free to explore the latest UI and all the exciting new features!");
}, 4500);
...
const splashTexts = [
  ...
  "Don't you think monkes are cool?",
  "I named this OS SwingOS because monkes swing on trees.",
  "OOH OOH AH AH",
];
...
const buttons = [
  ...
  { text: "Invis Cloak", title: "ㅤ", favicon: "/media/favicons/cloak/canvas.png" },
  { text: "Defualt Title & Favicon", title: "SwingOS", favicon: "/media/favicons/duckos.png" }
];
